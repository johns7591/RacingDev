    ...
    methods
        ...
        %SOLVE Run a basic transient analysis of the vehicle
            ...
            while true
                ...
                InertiaFront_Linear = InertiaFront...
                                    / (2*pi...
                                    * ((Result.LoadedRadiusFL(i)+Result.LoadedRadiusFR(i))/2)...
                                    * ((Result.EffectiveRadiusFL(i)+Result.EffectiveRadiusFR(i))/2));
                InertiaRear_Linear  = InertiaRear...
                                    / (2*pi...
                                    * ((Result.LoadedRadiusRL(i)+Result.LoadedRadiusRR(i))/2)...
                                    * ((Result.EffectiveRadiusRL(i)+Result.EffectiveRadiusRR(i))/2));
